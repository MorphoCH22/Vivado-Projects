...
HD_PWD='C:/Users/moizc/OneDrive/Desktop/MY AWESOME PROJECTS/vivado/AutomobileControllerSystem/AutomobileControllerSystem.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AutomobileControllerSys.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AutomobileControllerSys.tcl -notrace
