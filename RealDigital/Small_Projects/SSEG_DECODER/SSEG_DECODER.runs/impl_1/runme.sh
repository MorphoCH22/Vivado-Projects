...
HD_PWD='C:/Users/moizc/Desktop/MY AWESOME PROJECTS/vivado/WIP/SSEG_DECODER/SSEG_DECODER.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SSEG.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SSEG.tcl -notrace
