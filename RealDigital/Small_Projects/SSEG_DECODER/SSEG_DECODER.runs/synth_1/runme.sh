...
HD_PWD='C:/Users/moizc/Desktop/MY AWESOME PROJECTS/vivado/WIP/SSEG_DECODER/SSEG_DECODER.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SSEG.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SSEG.tcl
