...
HD_PWD='C:/Users/moizc/Desktop/MY AWESOME PROJECTS/vivado/WIP/NAND_NOR_LATCH/NAND_NOR_LATCH.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nando.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nando.tcl
