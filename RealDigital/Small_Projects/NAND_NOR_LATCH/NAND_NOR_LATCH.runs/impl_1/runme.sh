...
HD_PWD='C:/Users/moizc/Desktop/MY AWESOME PROJECTS/vivado/WIP/NAND_NOR_LATCH/NAND_NOR_LATCH.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nando.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nando.tcl -notrace
