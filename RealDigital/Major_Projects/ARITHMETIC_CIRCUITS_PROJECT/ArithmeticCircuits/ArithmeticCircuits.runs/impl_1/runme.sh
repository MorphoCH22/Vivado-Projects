...
HD_PWD='C:/Users/moizc/Desktop/MY AWESOME PROJECTS/vivado/WIP/ArithmeticCircuits/ArithmeticCircuits.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AddSub.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AddSub.tcl -notrace
