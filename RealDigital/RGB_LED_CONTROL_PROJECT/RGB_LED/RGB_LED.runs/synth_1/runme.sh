...
HD_PWD='C:/Users/moizc/OneDrive/Desktop/MY AWESOME PROJECTS/vivado/RGB_LED/RGB_LED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RGB_LED.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RGB_LED.tcl
