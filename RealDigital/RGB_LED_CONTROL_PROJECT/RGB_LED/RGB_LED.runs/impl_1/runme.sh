...
HD_PWD='C:/Users/moizc/OneDrive/Desktop/MY AWESOME PROJECTS/vivado/RGB_LED/RGB_LED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RGB_LED.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RGB_LED.tcl -notrace
