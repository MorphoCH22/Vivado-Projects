...
HD_PWD='C:/Users/moizc/Desktop/MY AWESOME PROJECTS/vivado/WIP/SPI_PROJECT/SPI_project/SPI_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopSPI.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopSPI.tcl
